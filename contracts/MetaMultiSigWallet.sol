...
contract MetaMultiSigWallet {
    ...
    constructor(
        ...
        require(
            ...
            "constructor: must ne non-zero signatures required"
        );
        ...
        onlySelf
    {
        ...
        require(
            newSignaturesRequired > 0,
            "removeSigner: addSigner: must be non-zero sigs required"
        );
        ...
        onlySelf
    {
        require(
            newSignaturesRequired > 0,
            "updateSignaturesRequired: addSigner: must be non-zero sigs required"
        );
        signaturesRequired = newSignaturesRequired;
    }
    ...
    function closeStream(address payable to) public onlySelf {
        ...
        _streamWithdraw(to, streams[to].amount, "stream already closed");
        delete streams[to];
        emit CloseStream((to));
    }
}
